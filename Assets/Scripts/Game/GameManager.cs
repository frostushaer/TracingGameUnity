...
public class GameManager : MonoBehaviour
{
		...
		void Update ()
		{
				...
				{
					Debug.Log("Start" + hit2d.transform.tag + ":" + hit2d.transform.name);
				...
				{
					Debug.Log("Collider" + hit2d.transform.tag + ":" + hit2d.transform.name);
					shape.DisableTracingHand ();
										EnableHand ();
								}
						}
		...
		private void CheckPathComplete ()
		{
				if (fillAmount >= path.completeOffset) {
						...
						if (hit2d.collider != null) {
								if (hit2d.transform.tag == "Start")
				{
					Debug.Log("Start1" + hit2d.transform.tag + ":" + hit2d.transform.name);
